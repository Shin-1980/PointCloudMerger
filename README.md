...
These scripts are designed for users who utilize [the app](https://github.com/Shin-1980/PointCloudGenerator) to store point cloud, 2D images, and [ARFrame](https://developer.apple.com/documentation/arkit/arframe).
